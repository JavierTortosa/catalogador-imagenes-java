...
//            configCargaImgSubItems.add(new MenuItemDefinition(null, MenuItemType.RADIO_GROUP_END, null, null));
//            configCargaImgSubItems.add(new MenuItemDefinition(null, MenuItemType.SEPARATOR, null, null));
//
//            // --- Grupo para Ordenación por Defecto: Criterio ---
//            configCargaImgSubItems.add(new MenuItemDefinition(null, MenuItemType.LABEL, "Criterio de Ordenación por Defecto:", null)); // Un JLabel como título
//            List<MenuItemDefinition> configOrdenCriterioSubItems = List.of(
//                new MenuItemDefinition(null, MenuItemType.RADIO_GROUP_START, null, null),
//                new MenuItemDefinition(AppActionCommands.CMD_CONFIG_ORDEN_DEFAULT_CRITERIO_NOMBRE, MenuItemType.RADIO_BUTTON_ITEM, "Nombre", null),
//                new MenuItemDefinition(AppActionCommands.CMD_CONFIG_ORDEN_DEFAULT_CRITERIO_TAMANO, MenuItemType.RADIO_BUTTON_ITEM, "Tamaño", null),
//                new MenuItemDefinition(AppActionCommands.CMD_CONFIG_ORDEN_DEFAULT_CRITERIO_FECHA, MenuItemType.RADIO_BUTTON_ITEM, "Fecha", null),
//                new MenuItemDefinition(AppActionCommands.CMD_CONFIG_ORDEN_DEFAULT_CRITERIO_EXTENSION, MenuItemType.RADIO_BUTTON_ITEM, "Extensión", null),
//                new MenuItemDefinition(null, MenuItemType.RADIO_GROUP_END, null, null)
//            );
//            // Añadir cada item de configOrdenCriterioSubItems directamente a configCargaImgSubItems
//            // o envolverlos en un sub-submenú si prefieres más anidación.
//            // Por simplicidad, los añado directamente aquí, pero MenuBarBuilder necesitará manejarlos.
//            // Una forma más limpia es hacer un submenú para "Criterio Default" y otro para "Dirección Default".
//            configCargaImgSubItems.add(new MenuItemDefinition(null, MenuItemType.SUB_MENU, "Criterio Predeterminado", configOrdenCriterioSubItems));
//            configCargaImgSubItems.add(new MenuItemDefinition(null, MenuItemType.SEPARATOR, null, null));
//
//            // --- Grupo para Ordenación por Defecto: Dirección ---
//            configCargaImgSubItems.add(new MenuItemDefinition(null, MenuItemType.LABEL, "Dirección de Ordenación por Defecto:", null));
//            List<MenuItemDefinition> configOrdenDireccionSubItems = List.of(
//                new MenuItemDefinition(null, MenuItemType.RADIO_GROUP_START, null, null),
//                new MenuItemDefinition(AppActionCommands.CMD_CONFIG_ORDEN_DEFAULT_DIRECCION_NINGUNO, MenuItemType.RADIO_BUTTON_ITEM, "Sin Ordenar", null),
//                new MenuItemDefinition(AppActionCommands.CMD_CONFIG_ORDEN_DEFAULT_DIRECCION_ASC, MenuItemType.RADIO_BUTTON_ITEM, "Ascendente", null),
//                new MenuItemDefinition(AppActionCommands.CMD_CONFIG_ORDEN_DEFAULT_DIRECCION_DESC, MenuItemType.RADIO_BUTTON_ITEM, "Descendente", null),
//                new MenuItemDefinition(null, MenuItemType.RADIO_GROUP_END, null, null)
//            );
//            configCargaImgSubItems.add(new MenuItemDefinition(null, MenuItemType.SUB_MENU, "Dirección Predeterminada", configOrdenDireccionSubItems));
//
//            // Finalmente, añadir el submenú "Carga de Imágenes" al menú "Configuración"
//            configSubItems.add(new MenuItemDefinition(null, MenuItemType.SUB_MENU, "Carga y Ordenación", configCargaImgSubItems));
