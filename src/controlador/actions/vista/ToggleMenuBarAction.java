...
public class ToggleMenuBarAction extends BaseVisorAction {
    ...
    public ToggleMenuBarAction(VisorController controller) {
        // --- TEXTO NUEVO ---
        super("Barra de Menu", controller); // Texto del menú
        putValue(Action.SHORT_DESCRIPTION, "Mostrar u ocultar la Barra de Menú");
        ...
        if (controller != null && controller.getConfigurationManager() != null) {
            ...
            System.out.println("[ToggleMenuBarAction] Estado inicial leído (" + CONFIG_KEY + "): " + initialState);
        } else {
             System.err.println("WARN [ToggleMenuBarAction]: Controller o ConfigMgr nulos en constructor. Estado inicial no establecido.");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (source instanceof JCheckBoxMenuItem) {
            ...
            newState = ((JCheckBoxMenuItem) source).isSelected();
             ...
             System.out.println("WARN [ToggleMenuBarAction]: Evento no es de JCheckBoxMenuItem, toggleando estado: " + newState);
        }
