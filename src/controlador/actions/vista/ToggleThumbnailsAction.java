...
public class ToggleThumbnailsAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent e) {
        if (viewManagerRef == null || configManagerRef == null) { // configManagerRef no se usa aquí, pero está bien el chequeo
            System.err.println("ERROR CRÍTICO [ToggleThumbnailsAction]: ViewManager es nulo.");
            return;
        }

        boolean nuevoEstadoVisible = Boolean.TRUE.equals(getValue(Action.SELECTED_KEY));
        System.out.println("[ToggleThumbnailsAction actionPerformed] para: " + componentIdForViewManager + ", nuevo estado: " + nuevoEstadoVisible);
