...
public class ToggleThumbnailsAction extends BaseVisorAction {
    ...
    public ToggleThumbnailsAction(VisorController controller) {
        ...
        if (controller != null && controller.getConfigurationManager() != null) {
            ...
            System.out.println("[ToggleThumbnailsAction] Estado inicial leído (" + CONFIG_KEY + "): " + initialState);
        } else {
             System.err.println("WARN [ToggleThumbnailsAction]: Controller o ConfigMgr nulos en constructor. Estado inicial no establecido.");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (source instanceof JCheckBoxMenuItem) {
            ...
            newState = ((JCheckBoxMenuItem) source).isSelected();
             ...
             System.out.println("WARN [ToggleThumbnailsAction]: Evento no es de JCheckBoxMenuItem, toggleando estado: " + newState);
        }
