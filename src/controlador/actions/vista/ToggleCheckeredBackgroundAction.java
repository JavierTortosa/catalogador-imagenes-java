...
public class ToggleCheckeredBackgroundAction extends BaseVisorAction {
    ...
    public ToggleCheckeredBackgroundAction(VisorController controller) {
        // --- TEXTO NUEVO ---
        super("ToggleCheckeredBackgroundActionBarra de Menu", controller); // Texto del menú
        putValue(Action.SHORT_DESCRIPTION, "Mostrar u ocultar la ToggleCheckeredBackgroundActionBarra de Menú");
        ...
        if (controller != null && controller.getConfigurationManager() != null) {
            ...
            System.out.println("[ToggleCheckeredBackgroundAction] Estado inicial leído (" + CONFIG_KEY + "): " + initialState);
        } else {
             System.err.println("WARN [ToggleCheckeredBackgroundAction]: Controller o ConfigMgr nulos en constructor. Estado inicial no establecido.");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (source instanceof JCheckBoxMenuItem) {
            ...
            newState = ((JCheckBoxMenuItem) source).isSelected();
             ...
             System.out.println("WARN [ToggleCheckeredBackgroundAction]: Evento no es de JCheckBoxMenuItem, toggleando estado: " + newState);
        }

        // Llamar al método del controlador para aplicar el cambio y actualizar config
        controller.setComponenteVisibleAndUpdateConfig("ToggleCheckeredBackgroundActionBarra_de_Menu", newState);
