...
public class ToggleLocationBarAction extends BaseVisorAction {
    ...
    public ToggleLocationBarAction(VisorController controller) {
        ...
        if (controller != null && controller.getConfigurationManager() != null) {
            ...
            System.out.println("[ToggleLocationBarAction] Estado inicial leído (" + CONFIG_KEY + "): " + initialState);
        } else {
             System.err.println("WARN [ToggleLocationBarAction]: Controller o ConfigMgr nulos en constructor. Estado inicial no establecido.");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (source instanceof JCheckBoxMenuItem) {
            ...
            newState = ((JCheckBoxMenuItem) source).isSelected();
             ...
             System.out.println("WARN [ToggleLocationBarAction]: Evento no es de JCheckBoxMenuItem, toggleando estado: " + newState);
        }
