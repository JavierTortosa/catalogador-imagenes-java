...
public class ToggleSubcarpetasAction extends BaseVisorAction
{
	/**
	 * 
	 */
	...
	public ToggleSubcarpetasAction (VisorController controller, IconUtils iconUtils, int width, int height) 
	{
		super("Mostrar Subcarpetas", controller);
        ...
        if (icon != null) {
            ...
            System.err.println("WARN [SubcarpetasAction]: No se pudo cargar el icono 7001-subcarpetas_48x48.png");
	...
	public void actionPerformed (ActionEvent e)
	{
		if (controller != null) {
            ...
            System.out.println("TODO: Llamar a controller.aplicarZoomAlto() en SubcarpetasAction");
        } else {
            System.err.println("Error: Controller es null en SubcarpetasAction");
        }
	}
}
