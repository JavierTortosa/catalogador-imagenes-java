...
public class ProjectListCoordinator extends AbstractListCoordinator  {
    ...
    private ProjectController projectController; // Referencia al controlador de proyecto
    ...
    // =================================================================================
    // === MÉTODOS DE LA INTERFAZ IListCoordinator (SIN CAMBIOS) ===
    // =================================================================================

    @Override
    public void seleccionarSiguiente() {
    	
    	if (isSincronizandoUI()) return;
        ...
        int nextIndex = (currentIndex == -1) ? 0 : currentIndex + 1; 
    ...
    // =================================================================================
    // === MÉTODOS AUXILIARES (CON MODIFICACIONES) ===
    // =================================================================================
    ...
    private synchronized void seleccionarImagenEnLista(JList<String> lista, int indice) {
        ...
        if (indice < 0 || indice >= lista.getModel().getSize()) {
            if (model.getProyectoListContext().getSelectedImageKey() != null) {
                ...
                fireMasterSelectionChanged(-1, lista.getName()); 
    ...
    // =================================================================================
    // === Getters y Setters (CON MODIFICACIONES) ===
    // =================================================================================

    // --- INICIO DE LA MODIFICACIÓN ---
    /**
     * Establece la referencia al ProjectController para permitir la comunicación
     * desde el coordinador.
     * @param projectController La instancia del controlador de proyecto.
     */
