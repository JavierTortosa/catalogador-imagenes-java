...
import controlador.actions.coleccion.AddFolderToCollectionAction;
...
public class ActionFactory {
    ...
    // Constante para la cantidad de paneo incremental (se puede mover a una clase
    // de constantes globales si existe)
     ...
     * @param view                  La vista principal (JFrame). Puede ser null
     *                              inicialmente.
    ...
    public ActionFactory(
        ...
        this.configuration = Objects.requireNonNull(configuration,
                "ConfigurationManager no puede ser null en ActionFactory");
        ...
        this.generalController = Objects.requireNonNull(generalController,
                "GeneralController no puede ser null en ActionFactory");
        ...
        this.listCoordinator = Objects.requireNonNull(listCoordinator,
                "IListCoordinator no puede ser null en ActionFactory");

        // 2.3. Asignar mapa de iconos.
        this.comandoToIconKeyMap = Objects.requireNonNull(comandoToIconInfoMap,
     ...
     * Este método debe ser llamado antes de que se necesiten las acciones para
     * construir
     ...
     * Este método DEBE ser llamado DESPUÉS de crear la 'view' y de inyectarla en
     * esta fábrica.
     */
    public void initializeViewDependentActions() {
        ...
        if (view == null) {
            throw new IllegalStateException(
                    "No se pueden inicializar las acciones dependientes de la vista porque la 'view' es null.");
        }

        createViewDependentActions();

        logger.debug(
                "  [ActionFactory] Actions dependientes de la vista inicializadas. Total de actions: "
                        + this.actionMap.size());
    ...
    private void createCoreActions() {
        ...
        actionMap.put(AppActionCommands.CMD_ZOOM_TIPO_AUTO,
                createAplicarModoZoomAction(AppActionCommands.CMD_ZOOM_TIPO_AUTO, "Zoom Automático",
                        ZoomModeEnum.DISPLAY_ORIGINAL));
        actionMap.put(AppActionCommands.CMD_ZOOM_TIPO_ANCHO,
                createAplicarModoZoomAction(AppActionCommands.CMD_ZOOM_TIPO_ANCHO, "Ajustar a Ancho",
                        ZoomModeEnum.FIT_TO_WIDTH));
        actionMap.put(AppActionCommands.CMD_ZOOM_TIPO_ALTO,
                createAplicarModoZoomAction(AppActionCommands.CMD_ZOOM_TIPO_ALTO, "Ajustar a Alto",
                        ZoomModeEnum.FIT_TO_HEIGHT));
        actionMap.put(AppActionCommands.CMD_ZOOM_TIPO_AJUSTAR,
                createAplicarModoZoomAction(AppActionCommands.CMD_ZOOM_TIPO_AJUSTAR, "Ajustar a Pantalla",
                        ZoomModeEnum.FIT_TO_SCREEN));
        actionMap.put(AppActionCommands.CMD_ZOOM_TIPO_FIJO,
                createAplicarModoZoomAction(AppActionCommands.CMD_ZOOM_TIPO_FIJO, "Zoom Fijo",
                        ZoomModeEnum.MAINTAIN_CURRENT_ZOOM));
        actionMap.put(AppActionCommands.CMD_ZOOM_TIPO_ESPECIFICADO,
                createAplicarModoZoomAction(AppActionCommands.CMD_ZOOM_TIPO_ESPECIFICADO, "Zoom Especificado",
                        ZoomModeEnum.USER_SPECIFIED_PERCENTAGE));
        actionMap.put(AppActionCommands.CMD_ZOOM_TIPO_RELLENAR,
                createAplicarModoZoomAction(AppActionCommands.CMD_ZOOM_TIPO_RELLENAR, "Escalar para Rellenar",
                        ZoomModeEnum.FILL));
        ...
        actionMap.put(AppActionCommands.CMD_FILTRO_SET_TYPE_FOLDER,
                createSetFilterTypeAction(FilterSource.FOLDER_PATH));
        ...
        List<vista.config.UIDefinitionService.TemaDefinicion> temasDefiniciones = UIDefinitionService
                .getTemasPrincipales();

        for (vista.config.UIDefinitionService.TemaDefinicion temaDef : temasDefiniciones) {
            // Generamos la clave de comando canónica para esta acción (ej:
            // "cmd.tema.cyan_light")
            String commandKey = "cmd.tema." + temaDef.id();

            // Creamos la acción y la guardamos en el mapa.
            // Necesitaremos modificar `createToggleThemeAction` para que acepte el
            // commandKey.
        ...
        actionMap.put(AppActionCommands.CMD_CONFIG_CARGA_SOLO_CARPETA, createSetSubfolderReadModeAction(
                AppActionCommands.CMD_CONFIG_CARGA_SOLO_CARPETA, "Mostrar Solo Carpeta Actual", false));
        actionMap.put(AppActionCommands.CMD_CONFIG_CARGA_CON_SUBCARPETAS, createSetSubfolderReadModeAction(
                AppActionCommands.CMD_CONFIG_CARGA_CON_SUBCARPETAS, "Mostrar Imágenes de Subcarpetas", true));
        ...
        actionMap.put(AppActionCommands.CMD_INFOBAR_CONFIG_TOGGLE_SUPERIOR_VISIBLE,
                new ToggleUIElementVisibilityAction(this.viewManager, this.configuration,
                        "Mostrar Barra de Información Superior", ConfigKeys.INFOBAR_SUP_VISIBLE,
                        "REFRESH_INFO_BAR_SUPERIOR", AppActionCommands.CMD_INFOBAR_CONFIG_TOGGLE_SUPERIOR_VISIBLE));
        actionMap.put(AppActionCommands.CMD_INFOBAR_CONFIG_TOGGLE_SUPERIOR_NOMBRE_RUTA,
                new ToggleUIElementVisibilityAction(this.viewManager, this.configuration,
                        "Mostrar Nombre/Ruta Archivo (Sup.)", ConfigKeys.INFOBAR_SUP_NOMBRE_RUTA_VISIBLE,
                        "REFRESH_INFO_BAR_SUPERIOR", AppActionCommands.CMD_INFOBAR_CONFIG_TOGGLE_SUPERIOR_NOMBRE_RUTA));
        actionMap.put(AppActionCommands.CMD_INFOBAR_CONFIG_TOGGLE_SUPERIOR_INDICE_TOTAL,
                new ToggleUIElementVisibilityAction(this.viewManager, this.configuration,
                        "Mostrar Índice/Total Imágenes", ConfigKeys.INFOBAR_SUP_INDICE_TOTAL_VISIBLE,
        ...
        actionMap.put(AppActionCommands.CMD_INFOBAR_CONFIG_TOGGLE_SUPERIOR_DIMENSIONES,
                new ToggleUIElementVisibilityAction(this.viewManager, this.configuration,
                        "Mostrar Dimensiones Originales", ConfigKeys.INFOBAR_SUP_DIMENSIONES_VISIBLE,
        ...
        actionMap.put(AppActionCommands.CMD_INFOBAR_CONFIG_FORMATO_SUPERIOR_NOMBRE_RUTA_SOLO_NOMBRE,
                new SetInfoBarTextFormatAction(this.viewManager, this.configuration, "Solo Nombre de Archivo",
                        ConfigKeys.INFOBAR_SUP_NOMBRE_RUTA_FORMATO, "solo_nombre", "REFRESH_INFO_BAR_SUPERIOR",
        ...
        actionMap.put(AppActionCommands.CMD_INFOBAR_CONFIG_FORMATO_SUPERIOR_NOMBRE_RUTA_RUTA_COMPLETA,
                new SetInfoBarTextFormatAction(this.viewManager, this.configuration, "Ruta Completa y Nombre",
                        ConfigKeys.INFOBAR_SUP_NOMBRE_RUTA_FORMATO, "ruta_completa", "REFRESH_INFO_BAR_SUPERIOR",
        ...
        actionMap.put(AppActionCommands.CMD_INFOBAR_CONFIG_TOGGLE_INFERIOR_VISIBLE,
                new ToggleUIElementVisibilityAction(this.viewManager, this.configuration,
                        "Mostrar Barra de Estado/Control Inferior", ConfigKeys.INFOBAR_INF_VISIBLE,
                        "REFRESH_INFO_BAR_INFERIOR", AppActionCommands.CMD_INFOBAR_CONFIG_TOGGLE_INFERIOR_VISIBLE));
        actionMap.put(AppActionCommands.CMD_INFOBAR_CONFIG_TOGGLE_INFERIOR_NOMBRE_RUTA,
                new ToggleUIElementVisibilityAction(this.viewManager, this.configuration,
                        "Mostrar Nombre/Ruta Archivo (Inf.)", ConfigKeys.INFOBAR_INF_NOMBRE_RUTA_VISIBLE,
                        "REFRESH_INFO_BAR_INFERIOR", AppActionCommands.CMD_INFOBAR_CONFIG_TOGGLE_INFERIOR_NOMBRE_RUTA));
        actionMap.put(AppActionCommands.CMD_INFOBAR_CONFIG_TOGGLE_INFERIOR_ICONO_ZM,
                new ToggleUIElementVisibilityAction(this.viewManager, this.configuration,
                        "Mostrar Icono Zoom Manual (Inf.)", ConfigKeys.INFOBAR_INF_ICONO_ZM_VISIBLE,
                        "REFRESH_INFO_BAR_INFERIOR", AppActionCommands.CMD_INFOBAR_CONFIG_TOGGLE_INFERIOR_ICONO_ZM));
        actionMap.put(AppActionCommands.CMD_INFOBAR_CONFIG_TOGGLE_INFERIOR_ICONO_PROP,
                new ToggleUIElementVisibilityAction(this.viewManager, this.configuration,
                        "Mostrar Icono Proporciones (Inf.)", ConfigKeys.INFOBAR_INF_ICONO_PROP_VISIBLE,
                        "REFRESH_INFO_BAR_INFERIOR", AppActionCommands.CMD_INFOBAR_CONFIG_TOGGLE_INFERIOR_ICONO_PROP));
        actionMap.put(AppActionCommands.CMD_INFOBAR_CONFIG_TOGGLE_INFERIOR_ICONO_SUBC,
                new ToggleUIElementVisibilityAction(this.viewManager, this.configuration,
                        "Mostrar Icono Subcarpetas (Inf.)", ConfigKeys.INFOBAR_INF_ICONO_SUBC_VISIBLE,
        ...
        actionMap.put(AppActionCommands.CMD_INFOBAR_CONFIG_TOGGLE_INFERIOR_CTRL_ZOOM_PCT,
                new ToggleUIElementVisibilityAction(this.viewManager, this.configuration,
                        "Mostrar Control % Zoom (Inf.)", ConfigKeys.INFOBAR_INF_CTRL_ZOOM_PCT_VISIBLE,
        ...
        actionMap.put(AppActionCommands.CMD_INFOBAR_CONFIG_TOGGLE_INFERIOR_CTRL_MODO_ZOOM,
                new ToggleUIElementVisibilityAction(this.viewManager, this.configuration,
                        "Mostrar Control Modo Zoom (Inf.)", ConfigKeys.INFOBAR_INF_CTRL_MODO_ZOOM_VISIBLE,
                        "REFRESH_INFO_BAR_INFERIOR",
        ...
        actionMap.put(AppActionCommands.CMD_INFOBAR_CONFIG_TOGGLE_INFERIOR_MENSAJES_APP,
                new ToggleUIElementVisibilityAction(this.viewManager, this.configuration,
                        "Mostrar Área de Mensajes (Inf.)", ConfigKeys.INFOBAR_INF_MENSAJES_APP_VISIBLE,
                        "REFRESH_INFO_BAR_INFERIOR",
        ...
        actionMap.put(AppActionCommands.CMD_INFOBAR_CONFIG_FORMATO_INFERIOR_NOMBRE_RUTA_SOLO_NOMBRE,
                new SetInfoBarTextFormatAction(this.viewManager, this.configuration, "Solo Nombre de Archivo",
                        ConfigKeys.INFOBAR_INF_NOMBRE_RUTA_FORMATO, "solo_nombre", "REFRESH_INFO_BAR_INFERIOR",
        ...
        actionMap.put(AppActionCommands.CMD_INFOBAR_CONFIG_FORMATO_INFERIOR_NOMBRE_RUTA_RUTA_COMPLETA,
                new SetInfoBarTextFormatAction(this.viewManager, this.configuration, "Ruta Completa y Nombre",
                        ConfigKeys.INFOBAR_INF_NOMBRE_RUTA_FORMATO, "ruta_completa", "REFRESH_INFO_BAR_INFERIOR",
        ...
        actionMap.put(AppActionCommands.CMD_PAN_TOP_EDGE,
                createPanActionAbsolute(AppActionCommands.CMD_PAN_TOP_EDGE, Direction.UP));
        actionMap.put(AppActionCommands.CMD_PAN_BOTTOM_EDGE,
                createPanActionAbsolute(AppActionCommands.CMD_PAN_BOTTOM_EDGE, Direction.DOWN));
        actionMap.put(AppActionCommands.CMD_PAN_LEFT_EDGE,
                createPanActionAbsolute(AppActionCommands.CMD_PAN_LEFT_EDGE, Direction.LEFT));
        actionMap.put(AppActionCommands.CMD_PAN_RIGHT_EDGE,
                createPanActionAbsolute(AppActionCommands.CMD_PAN_RIGHT_EDGE, Direction.RIGHT));

        actionMap.put(AppActionCommands.CMD_PAN_UP_INCREMENTAL,
                createPanActionIncremental(AppActionCommands.CMD_PAN_UP_INCREMENTAL, Direction.UP));
        actionMap.put(AppActionCommands.CMD_PAN_DOWN_INCREMENTAL,
                createPanActionIncremental(AppActionCommands.CMD_PAN_DOWN_INCREMENTAL, Direction.DOWN));
        actionMap.put(AppActionCommands.CMD_PAN_LEFT_INCREMENTAL,
                createPanActionIncremental(AppActionCommands.CMD_PAN_LEFT_INCREMENTAL, Direction.LEFT));
        actionMap.put(AppActionCommands.CMD_PAN_RIGHT_INCREMENTAL,
                createPanActionIncremental(AppActionCommands.CMD_PAN_RIGHT_INCREMENTAL, Direction.RIGHT));

        // 3.12. Crear y registrar Actions de Control de Fondo
        actionMap.put(AppActionCommands.CMD_BACKGROUND_THEME_COLOR, createSetBackgroundColorAction(
                AppActionCommands.CMD_BACKGROUND_THEME_COLOR, "clear", "Fondo Tema Claro"));
        actionMap.put(AppActionCommands.CMD_BACKGROUND_COLOR_SLOT_1, createSetBackgroundColorAction(
                AppActionCommands.CMD_BACKGROUND_COLOR_SLOT_1, "dark", "Fondo Tema Oscuro"));
        actionMap.put(AppActionCommands.CMD_BACKGROUND_COLOR_SLOT_2, createSetBackgroundColorAction(
                AppActionCommands.CMD_BACKGROUND_COLOR_SLOT_2, "blue", "Fondo Tema Azul"));
        actionMap.put(AppActionCommands.CMD_BACKGROUND_COLOR_SLOT_3, createSetBackgroundColorAction(
                AppActionCommands.CMD_BACKGROUND_COLOR_SLOT_3, "orange", "Fondo Tema Naranja"));
        actionMap.put(AppActionCommands.CMD_BACKGROUND_COLOR_SLOT_4, createSetBackgroundColorAction(
                AppActionCommands.CMD_BACKGROUND_COLOR_SLOT_4, "green", "Fondo Tema Verde"));

        actionMap.put(AppActionCommands.CMD_BACKGROUND_CHECKERED,
                createSetCheckeredBackgroundAction("Fondo a Cuadros"));
        ...
        // ---
        // Estas acciones delegan al GeneralController y son ContextSensitive (para su
        // selección).
        registerAction(AppActionCommands.CMD_VISTA_SINGLE, createSwitchDisplayModeAction(DisplayMode.SINGLE_IMAGE,
                AppActionCommands.CMD_VISTA_SINGLE, "Vista Imagen Única"));
        ...
        registerAction(AppActionCommands.CMD_VISTA_POLAROID, createSwitchDisplayModeAction(DisplayMode.POLAROID,
                AppActionCommands.CMD_VISTA_POLAROID, "Vista Polaroid"));
        ...
        // --- Acciones Simples
        registerAction(AppActionCommands.CMD_CONFIG_GUARDAR, createSaveConfigurationAction());
        registerAction(AppActionCommands.CMD_CONFIG_CARGAR_INICIAL, createRestoreDefaultConfigAction());
        registerAction(AppActionCommands.CMD_ZOOM_PERSONALIZADO, createSetCustomZoomAction());
    ...
    private void createViewDependentActions() {
        // Crear la Action genérica para funcionalidades pendientes primero, ya que
        // necesita la 'view'.
        ...
        registerAction(AppActionCommands.CMD_CAROUSEL_PLAY,
                new PlayCarouselAction("Iniciar Carrusel", this.carouselManager));
        registerAction(AppActionCommands.CMD_CAROUSEL_PAUSE,
                new PauseCarouselAction("Pausar Carrusel", this.carouselManager));
        registerAction(AppActionCommands.CMD_CAROUSEL_STOP,
                new StopCarouselAction("Detener Carrusel", this.carouselManager));
        ...
        actionMap.put(
                ...
                new ChangeCarouselSpeedAction(model, carouselManager, configuration,
                        ChangeCarouselSpeedAction.SpeedChangeType.INCREASE));
        actionMap.put(
                AppActionCommands.CMD_CAROUSEL_SPEED_DECREASE,
                new ChangeCarouselSpeedAction(model, carouselManager, configuration,
                        ChangeCarouselSpeedAction.SpeedChangeType.DECREASE));
        actionMap.put(
    ...
    private Action createSwitchDisplayModeAction(DisplayMode displayMode, String commandKey, String displayName) {
        ...
        // 2. Creamos la nueva acción usando el constructor CORREGIDO de
        // SwitchDisplayModeAction.
        // Ya no necesita el 'generalController'. Necesita 'displayModeManager' y
        // 'model'.
        ...
        // 3. Configuramos las propiedades visuales de la acción, como ya lo harías en
        // otros sitios
        if (icon != null) {
    ...
    private Action createSwitchToVisualizadorAction() {
        ...
        SwitchToVisualizadorAction action = new SwitchToVisualizadorAction("Modo Visualizador", icon,
        ...
        return new AbstractAction("Funcionalidad Pendiente") {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (e.getSource() instanceof AbstractButton) {
                    ...
                    if (textoComponente == null || textoComponente.isEmpty())
                        textoComponente = (String) getValue(Action.NAME);
                }
                if (textoComponente == null || textoComponente.isBlank())
                    textoComponente = e.getActionCommand();
                if (textoComponente == null)
                    textoComponente = "(desconocido)";

                String mensaje = "Funcionalidad para '" + textoComponente + "' aún no implementada.";

                // --- CAMBIO ---: Usamos null como componente padre para eliminar la
    ...
    private ImageIcon getIconForCommand(String appCommand) {
        ...
        if (info != null && info.iconKey() != null && !info.iconKey().isBlank()) {
            ...
            if (info.scope() == vista.config.IconScope.COMMON) {
                ...
                // Si no, llamamos al método para iconos tematizados (comportamiento por
                // defecto).
    ...
    private Action createToggleZoomManualAction() {
        ...
        return new ToggleZoomManualAction("Activar Zoom Manual", icon, this.zoomManager,
                this.generalController.getVisorController(), this.model);
    ...
    private Action createToggleZoomToCursorAction() {
        ...
        ToggleZoomToCursorAction action = new ToggleZoomToCursorAction("Zoom al Cursor", icon,
    ...
    private Action createAplicarModoZoomAction(String commandKey, String displayName, ZoomModeEnum modo) {
        ...
        // Creamos un Runnable (un callback) que llama al método de sincronización del
        // VisorController.
        // El VisorController es inyectado en ActionFactory a través del constructor,
        // así que tenemos acceso.
    ...
    private Action createFirstImageAction() {
        ...
        // Cambiamos la dependencia de listCoordinator a generalController (que
        // implementa IModoController)
    ...
    private Action createToggleNavegacionCircularAction() {
        return new ToggleNavegacionCircularAction("Alternar Navegación Circular", null, this.configuration, this.model,
                this.generalController.getVisorController(), ConfigKeys.COMPORTAMIENTO_NAVEGACION_CIRCULAR,
    ...
    private Action createFlipHorizontalAction() {
        ...
        FlipHorizontalAction action = new FlipHorizontalAction(this.editionManager, this.model, "Voltear Horizontal",
                icon);
        this.contextSensitiveActions.add(action);
        return action;
    ...
    /*
     * --- 4.6. Métodos Create para Actions de Archivo (usarán FileOperationsManager
     * o lógica interna) ---
     */
    // *********************************************************************************************************************************************************
    ...
    private Action createDeleteAction() {
        ...
        DeleteAction action = new DeleteAction("Eliminar Imagen", icon, this.fileOperationsManager, this.model);
        this.contextSensitiveActions.add(action);
        return action;
    ...
    private Action createToggleStatusBarAction() {
        return new ToggleUIElementVisibilityAction(this.viewManager, this.configuration, "Barra de Estado",
                ConfigKeys.INFOBAR_INF_VISIBLE, "barra_de_estado", AppActionCommands.CMD_VISTA_TOGGLE_INFOBAR_INFERIOR);
    ...
    private Action createToggleCheckeredBackgroundAction() {
        return new ToggleCheckeredBackgroundAction("Fondo a Cuadros", null, this.viewManager, this.configuration,
                "interfaz.menu.vista.fondo_a_cuadros.seleccionado", AppActionCommands.CMD_VISTA_TOGGLE_CHECKERED_BG);
    ...
    private Action createMostrarDialogoListaAction() {
        ...
        return new MostrarDialogoListaAction("Mostrar Lista de Imágenes", icon, this.model,
                this.generalController.getVisorController(), this.viewManager);
    ...
    private Action createToggleMiniatureTextAction() {
        return new ToggleMiniatureTextAction("Mostrar Nombres en Miniaturas", null, this.configuration, this.view,
                ConfigKeys.VISTA_MOSTRAR_NOMBRES_MINIATURAS_STATE, AppActionCommands.CMD_VISTA_TOGGLE_MINIATURE_TEXT);
    ...
    private Action createToggleThemeAction(String themeNameInternal, String displayNameForMenu, String commandKey) {
        return new ToggleThemeAction(this.themeManager, this.generalController.getVisorController(), themeNameInternal,
                displayNameForMenu, commandKey);
    ...
    private Action createSetSubfolderReadModeAction(String commandKey, String displayName,
            boolean representaModoIncluirSubcarpetas) {
        ImageIcon icon = null;
        return new SetSubfolderReadModeAction(displayName, icon, this.generalController, this.model,
                representaModoIncluirSubcarpetas, commandKey);
    ...
    private Action createToggleProporcionesAction() {
        ...
        return new ToggleProporcionesAction("Mantener Proporciones", icon, this.model,
                this.generalController.getVisorController());
    ...
    private Action createToggleSyncAction() {
        ...
        return new ToggleSyncAction("Sincronizar Visor/Carrusel", icon, this.model, this.configuration,
                this.generalController);
    ...
    private Action createToggleMarkImageAction() {
        ...
        ToggleMarkImageAction action = new ToggleMarkImageAction(this.generalController,
                "Marcar/Desmarcar para Proyecto", icon);
        this.contextSensitiveActions.add(action);
        return action;
    ...
    private Action createAddFilesToProjectAction() {
        // Esta acción tampoco necesita icono, o podemos asignarle uno genérico de añadir.
        return new AbstractAction("Añadir archivos al proyecto...") {
            private static final long serialVersionUID = 1L;

            @Override
            public void actionPerformed(ActionEvent e) {
                if (projectControllerRef != null) {
                    projectControllerRef.solicitarAnadirArchivosAlProyecto();
                }
            }
        };
    } // --- FIN del método createAddFilesToProjectAction ---
    ...
    private Action createToggleIgnoreCompressedAction() {
        ...
        ToggleIgnoreCompressedAction action = new ToggleIgnoreCompressedAction(
                generalController.getProjectController());
    ...
    private Action createMenuAction() {
        ...
        return new MenuAction("Menú Principal", icon, fullMenuStructure, this.actionMap, this.themeManager,
                this.configuration);
    ...
    private Action createPanActionIncremental(String command, Direction direction) {
        ...
        // Esto es necesario para que los JMenuItems que usen esta acción muestren un
        // icono.
        ImageIcon icon = getIconForCommand(command);
        if (icon != null) {
            action.putValue(Action.SMALL_ICON, icon);
    ...
    private Action createNavegarCarpetaSiguienteAction() {
        ...
        // Instanciamos la nueva clase
        EntrarEnSubcarpetaAction action = new EntrarEnSubcarpetaAction(this.generalController, "Entrar en Carpeta",
                icon);
        // La registramos como sensible al contexto
        this.contextSensitiveActions.add(action);
        return action;
    ...
    private Action createNavegarCarpetaRaizAction() {
        ...
        // La registramos como sensible al contexto para que se habilite/deshabilite
        // sola
        this.contextSensitiveActions.add(action);
    ...
    private Action createToggleLiveFilterAction() {
        ...
        return new ToggleLiveFilterAction(this.model, this.generalController, "Activar/Desactivar Filtro en Vivo",
                icon);
    } // --- Fin del método createToggleLiveFilterAction ---

    private Action createAddFilterAction(FilterType type) {
        String command = (type == FilterType.CONTAINS) ? AppActionCommands.CMD_FILTRO_ADD_POSITIVE
                : AppActionCommands.CMD_FILTRO_ADD_NEGATIVE;
    ...
    private Action createCycleSortAction() {
        ...
        // Configurar propiedades adicionales que no están en el constructor de la
        // Action.
    ...
    /*
     * --- 4.14. Acciones de la toolbar del GRID
     */
    // *********************************************************************************************************************************************************
    ...
    /*
     * 4.15 Acciones Simples
     */
    // *********************************************************************************************************************************************************
    private Action createSaveConfigurationAction() {
        return new AbstractAction("Guardar Configuración Actual") {
            private static final long serialVersionUID = 1L;
    ...
    } // ---FIN de metodo createSaveConfigurationAction---

    private Action createRestoreDefaultConfigAction() {
        return new AbstractAction("Restaurar Configuración Inicial") {
            private static final long serialVersionUID = 1L;

            @Override
            public void actionPerformed(ActionEvent e) {
                if (generalController != null && generalController.getVisorController() != null
                        && generalController.getVisorController().getConfigApplicationManager() != null) {
                    generalController.getVisorController().getConfigApplicationManager()
                    ...
                    if (input != null && !input.trim().isEmpty()) {
                        try {
                            ...
                            if (percentValue >= 1 && percentValue <= 5000) {
                                ...
                                JOptionPane.showMessageDialog(view, "Porcentaje inválido.", "Error de Entrada",
                                        JOptionPane.ERROR_MESSAGE);
                            }
                        } catch (NumberFormatException ex) {
                            JOptionPane.showMessageDialog(view, "Entrada inválida.", "Error de Formato",
                                    JOptionPane.ERROR_MESSAGE);
                        }
                    }
                }
    ...
    private Action createRefreshUIAction() {
        return new AbstractAction("Refrescar UI") {
            private static final long serialVersionUID = 1L;

            @Override
            public void actionPerformed(ActionEvent e) {
                if (viewManager != null) {
                    viewManager.ejecutarRefrescoCompletoUI();
                }
            }
        };
    } // ---FIN de metodo createRefreshUIAction---

    private Action createAddFolderToCollectionAction() {
        ImageIcon icon = getIconForCommand(AppActionCommands.CMD_COLECCION_AÑADIR_CARPETA_ACTUAL);
        return new AddFolderToCollectionAction("Añadir a Colección", icon, this.imageListManager, this.model);
    } // ---FIN de metodo [createAddFolderToCollectionAction]---

    /**
     * Crea e inicializa las acciones que dependen de componentes creados
     * tardíamente,
     * como el ImageListManager. Debe llamarse al final del proceso de
     * inicialización.
     */
    public void initializeLateActions() {
        logger.debug("  [ActionFactory] Inicializando acciones tardías...");

        // --- Acciones de Gestión de Colección ---
        if (this.imageListManager != null) {
            registerAction(AppActionCommands.CMD_COLECCION_AÑADIR_CARPETA_ACTUAL, createAddFolderToCollectionAction());
        } else {
            logger.error("No se pudo crear 'AddFolderToCollectionAction' porque ImageListManager es nulo.");
        }
    } // ---FIN de metodo [initializeLateActions]---
    ...
    public Map<String, IconInfo> getComandoToIconKeyMap() {
        return Collections.unmodifiableMap(this.comandoToIconKeyMap);
    }

    public int getIconoAncho() {
        return this.iconoAncho;
    }

    public int getIconoAlto() {
        return this.iconoAlto;
    }
    ...
    public void actualizarIconosDeAcciones() {
        ...
        for (Map.Entry<String, Action> entry : actionMap.entrySet()) {
            ...
            // usa ThemeManager para obtener el tema ACTUAL. Por lo tanto, obtendrá el icono
            // correcto.
            ...
            if (comando.equals(AppActionCommands.CMD_VISTA_SWITCH_TO_VISUALIZADOR)) {
                logger.debug("DEBUG TEMA: Actualizando icono para 'MODO VISUALIZADOR'. Icono obtenido: "
                        + (nuevoIcono != null ? nuevoIcono.toString() : "NULL"));
    ...
    public void setEditionManager(IEditionManager editionManager) {
        this.editionManager = Objects.requireNonNull(editionManager);
    }

    public void setListCoordinator(IListCoordinator listCoordinator) {
        this.listCoordinator = Objects.requireNonNull(listCoordinator);
    }

    public void setCarouselManager(CarouselManager carouselManager) {
    ...
    public List<ContextSensitiveAction> getCarouselContextSensitiveActions() {
        return Collections.unmodifiableList(this.carouselContextSensitiveActions);
    }
